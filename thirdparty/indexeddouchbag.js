...
var IndexedDouchebag = function(name, version, upgradeCallback) {
...
IndexedDouchebag.prototype.transaction = function(stores, modeOrCallback, callback) {
...
IndexedDouchebag.prototype.get = function(store, key) {
    return this.transaction(store, function(tx) {
        return tx.objectStore(store).get(key);
    });
};

IndexedDouchebag.prototype.put = function(store, key, value) {
    return this.transaction(store, 'readwrite', function(tx) {
        tx.objectStore(store).put(value, key);
    });
};

IndexedDouchebag.prototype.delete = function(store, key) {
    return this.transaction(store, 'readwrite', function(tx) {
